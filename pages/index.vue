    ...
    <div>
        ...
        <div class="flex justify-center flex-col items-center md:px-20 px-5">
            ...
            <section id="work" class="min-h-screen w-full off-screen max-w-[900px]" ref="work">
                <h2 class="text-3xl my-8">myWork()</h2>
                <div class="relative my-16">
                    ...
                    <div
                        ...
                        <div class="mt-auto">
                            ...
                            <div>
                                <NuxtLink to="https://github.com/ayitinya/apartment-rental-site" target="_blank" :external="true" class="mr-2">
                                    <Icon name="fa6-brands:github" size="1.5rem" />
                                </NuxtLink>
                                <NuxtLink to="apartment-rental-site.vercel.app" target="_blank" :external="true" class="mr-2">
                ...
                <div class="relative my-16">
                    ...
                    <div
                        ...
                        <div class="mt-auto">
                            ...
                            <div>
                                <NuxtLink to="https://github.com/ayitinya/school-management-system" target="_blank" :external="true" class="mr-2">
                                    <Icon name="fa6-brands:github" size="1.5rem" />
                                </NuxtLink>
                                <NuxtLink to="https://school-management-system-nu.vercel.app" target="_blank" :external="true"
                                    class="mr-2">
                                    <Icon name="line-md:external-link-rounded" size="1.5rem" />
                                </NuxtLink>
                            </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <div class="p-5 border dark:border-gray-800/60 flex flex-col">
                            ...
                            <div class="mt-auto">
                                ...
                                <div>
                                    <NuxtLink to="https://github.com/ayitinya/ayitinya.github.io" target="_blank" :external="true" class="mr-2">
                                        <Icon name="fa6-brands:github" size="1.5rem" />
                                    </NuxtLink>
                                </div>
                            </div>
